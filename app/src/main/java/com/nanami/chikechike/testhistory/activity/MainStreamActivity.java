...
import com.nanami.chikechike.testhistory.Globals;
import com.nanami.chikechike.testhistory.TwitterUtils;
import com.nanami.chikechike.testhistory.adapter.MyFragmentPagerAdapter;
import com.nanami.chikechike.testhistory.dialog.SelectAccountDialogFragment;
import com.nanami.chikechike.testhistory.dialog.SelectTabKindDialogFragment;
...
public class MainStreamActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!TwitterUtils.hasAccessToken(this)) {
            ...
            // Load Account List
            TwitterUtils.Account _ = TwitterUtils.getAccount(this);
            if(_ != null){
                globals.initializeList();
                for(TwitterUtils.Account account : _.accounts){
